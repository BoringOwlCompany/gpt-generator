...
export const jsonPrompt = (structure: string) =>
  `Zwróć w postaci JSON: ${structure}. Nie dopisuj nic więcej, tak żeby odpowiedź można było sparsować funkcją JSON.parse. Nie używaj cudzysłowów w tekście. Nie dodawaj nigdzie znaków kończących linie.`;
...
export const titlesJsonPrompt = jsonPrompt(JSON.stringify(titlesObject));
